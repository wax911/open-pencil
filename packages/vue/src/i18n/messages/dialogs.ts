...
export const dialogMessageDefaults = {
  ...
  designDoc: 'Design doc (DESIGN.md)',
  designDocDescription:
    'Attach a DESIGN.md brief so the AI retains your design direction and style.',
  loadDesignDoc: 'Load from file',
  designDocLoadedFile: params('Loaded {name}'),
  clearDesignDoc: 'Clear design doc',
  designDocContentPlaceholder: 'Paste or edit your design brief here…',
  clear: 'Clear',
